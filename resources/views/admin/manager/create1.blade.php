...
@section('breadcrumb')
  <li class="breadcrumb-item"><a href="{{route('admin.manager.index')}}">Productos</a></li>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <label>Slug</label>
                  <input
                  readonly v-model="generarSLug"  class="form-control" type="text" id="slug" name="slug" >
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <!-- Para usar select2 en razon social
                  ...
                  <select name="company_id" id="company_id" class="form-control" style="width: 100%;">
                    @foreach($companys as $company)
                     ...
                     @if ($company['id'] == $manag['company_id'])
                        <option readonly value="{{ $manag->company_id }}" selected="selected">{{ $manag->company_id }}{{ $company->razon_social}}</option>
                     @else
                        <option value="{{ $manag->company_id }}">{{ $company->razon_social}}</option>
                     @endif
                    @endforeach
                    </select>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <br>
                                <div class="progress">
                                    <div id="barraprogreso" class="progress-bar" role="progressbar" style="width: 0%;" v-bind:style="{width:porcentajededescuento+'%'}" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100">@{{porcentajededescuento}}%</div>
                                </div>
                            </div>
                            <!-- /.form-group -->
